...
def run_evening(dry_run: bool = False):
    """Step 4-6: Collect feedback, evolve skills, send daily report."""
    print(f"[{datetime.now()}] === EVENING PHASE ===")

    # Step 4: Collect feedback
    print("[4/6] Collecting expert feedback...")
    ...
    # Step 5: Evolve skills from actionable feedback
    print("[5/6] Evolving skills...")
    from agent.skill_evolver import evolve_from_feedback
    evolved = 0
    for question_id in summary.get("actionable", []):
    ...
    print(f"  Skills evolved: {evolved}")

    # Step 6: Send daily report
    print("[6/6] Sending daily report...")
...
def main():
    ...
    parser.add_argument("--phase", choices=["morning", "evening", "full"], default="full",
